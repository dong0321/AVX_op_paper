...
straightforward set of predefined MPI operations, with data representation or operations limitation.
%and is using CPU resources only
%without the need of external or extra hardware.
The implementation supports multiple ISA, covering most Intel processor versions either with legacy SSE and AVX or advanced AVX-512.
...
operation and memory copy to indicate the peak memory bandwidth
