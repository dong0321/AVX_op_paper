...
\begin{abstract}
  ...
  and efficient.  Experiments are conducted on an Intel Xeon Gold, AMD Zen 2 and Arm A64FX clusters,
...
Section~\ref{sec:platformsexperiments} displys the extension of reduction work on AMD and Arm platforms.
...
memcpy.  To be remarked, when the reduction buffer size increases,
