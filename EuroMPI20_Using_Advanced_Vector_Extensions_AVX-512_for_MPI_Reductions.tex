...
in Compilers. These types empower the programmer to directly choose the implementation
...
the fact that each one of them is simultaneously using our AVXs optimized \ompi
