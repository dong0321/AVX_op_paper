...
%
  Furthermore, we demonstrate the efficiency of our AVX512-enabled approach by a distributed machine learning appilcation using Horovod shows we achive 12\% speedup.
\end{abstract}
