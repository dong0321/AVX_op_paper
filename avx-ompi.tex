...
%
We can see, those work focused on using new instructions
...
Intel architecture-based processors supported by a compiler. The use of intrinsics
...
\begin{figure}[h]
    ...
    \label{fig:papi_ins}\vspace{-0.5cm}
\end{figure}
...
it processes two elements. Our new implementation use AVX-512 vector instruction
...
performance can be improved by an order of magnitude compared with the
...
\begin{figure}[h]
    \centering
    % trim={<left> <lower> <right> <upper>}
    \includegraphics[trim={0 0 0 1.5cm},clip, width=\linewidth]{avx_sum_review.pdf}
...
\begin{figure}[h]
    \centering
    % trim={<left> <lower> <right> <upper>}
    \includegraphics[trim={0 0 0 1.5cm},clip,width=\linewidth]{avx_band_review.pdf}
